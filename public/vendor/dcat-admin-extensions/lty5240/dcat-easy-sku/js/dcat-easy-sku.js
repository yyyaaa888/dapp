(function () {
    ...
    SKU.prototype.SKUForm = function (default_sku, params) {
        ...
        if (attr_names.length === 0) {
            ...
            thead_html += '<th data-field="image" style="width: 70px">图片 </th>';
            thead_html += '<th data-field="goods_no" style="width: 100px">商家编码 <input type="text" class="form-control"></th>';
            thead_html += '<th data-field="goods_price" style="width: 100px">销售价 <input type="text" class="form-control"></th>';
            thead_html += '<th data-field="line_price" style="width: 100px">划线价 <input type="text" class="form-control"></th>';
            thead_html += '<th data-field="stock_num" style="width: 100px">库存 <input type="text" class="form-control"></th>';
            thead_html += '<th data-field="goods_weight" style="width: 100px">重量(kg) <input type="text" class="form-control"></th>';
            ...
            cartesianProductOf.forEach(function (sku_item) {
                ...
                tbody_html += '<td data-field="image"><input value="" type="hidden" class="form-control"><span class="Js_sku_upload">' + uploadImageButton + '</span></td>';
                tbody_html += '<td data-field="goods_no"><input value="" type="text" class="form-control"></td>';
                tbody_html += '<td data-field="goods_price"><input value="" type="text" class="form-control"></td>';
                tbody_html += '<td data-field="line_price"><input value="" type="text" class="form-control"></td>';
                tbody_html += '<td data-field="stock_num"><input value="" type="text" class="form-control"></td>';
                tbody_html += '<td data-field="goods_weight"><input value="" type="text" class="form-control"></td>';
